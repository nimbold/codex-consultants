...
Other currently listed free Zen models can be selected with repeated `--model` flags, including `opencode/big-pickle`, `opencode/mimo-v2.5-free`, `opencode/north-mini-code-free`, and `opencode/nemotron-3-ultra-free`. Free-model availability and names are provider-managed and may change.
